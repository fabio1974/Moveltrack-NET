...
import net.moveltrack.report.interno.UtilsReport;
...
public class BoletoUtils implements Serializable {
	...
	public byte[] geraCarne(Carne carne,ServletContext servletContext) {
		List<MBoleto> mBoletos = mBoletoDao.findEmitidosByCarne(carne);
		try {
	...
	public byte[] getBoletoIuguInBytes(MBoleto mBoleto, ServletContext servletContext) throws DocumentException {
	
		Document document = new Document(PageSize.A4,2,2,36,36);
	...
	public PdfPTable getBoletoTable(MBoleto mBoleto, ServletContext servletContext){
		...
		PdfPTable table = new PdfPTable(58);
		...
		table.addCell(UtilsReport.getCellBoleto("NOSSO NÚMERO",mBoleto.getNossoNumero(),9,Paragraph.ALIGN_LEFT,8,8));
		table.addCell(UtilsReport.getEmptyCell(1));
		...
		table.addCell(UtilsReport.getCellBoleto("NOSSO NÚMERO",mBoleto.getNossoNumero(),9,Paragraph.ALIGN_RIGHT,8,8));

		table.addCell(UtilsReport.getCellBoleto("VENCIMENTO",sdf.format(mBoleto.getDataVencimento()),9,Paragraph.ALIGN_LEFT,8,9));
		table.addCell(UtilsReport.getEmptyCell(1));
		...
		table.addCell(UtilsReport.getCellBoleto("VALOR DO DOC",Moeda.mascaraDinheiro(mBoleto.getValor(),Moeda.DINHEIRO_REAL),9,Paragraph.ALIGN_LEFT,8,9));
		table.addCell(UtilsReport.getEmptyCell(1));
		...
		table.addCell(UtilsReport.getCellBoleto("DESCRIÇÃO",mensagem34==null?" ":mensagem34,39,Paragraph.ALIGN_LEFT,8,8));
		...
		table.addCell(UtilsReport.getCellBoleto("CPF/CNPJ SACADO",cliente.getCpf()!=null?cliente.getCpf():cliente.getCnpj(),9,Paragraph.ALIGN_LEFT,8,9));
		table.addCell(UtilsReport.getEmptyCell(1));
		...
		table.addCell(UtilsReport.getCellBoleto("NOME DO SACADO",cliente.getNome(),9,Paragraph.ALIGN_LEFT,8,5));
		table.addCell(UtilsReport.getEmptyCell(1));
