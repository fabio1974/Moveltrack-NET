    ...
    renderRows() {
        ...
        return list.map((item, index) => (
            ...
            <div className="row form-group" key={index}>
                ...
                <Field name={`${field}[${index}].nome`} component={Input} readOnly={readOnly} cols='12 6' />
                    ...
                    <div className='card-body' >
                        <Row>
                            ...
                            <div className="input-group input-group-xs"  >
                                <Field name='item' objectLabelProperty='nome' path='/pessoas' className='rs-sm' component={SelectInputAsync} cols='12 6' />
