 ...
 * 
 * Created at: 27/09/2011 - â€Ž14:27:10
 * 
 * ================================================================================
 * 
 ...
 * 
 * Criado em: 27/09/2011 - â€Ž14:27:10
 * 
 */
...
/**
 * LÃª os dados do Boleto e monta-os para uso em {@linkplain #texts()} e {@linkplain #images()}. 
 * 
...
class BoletoDataBuilder {
	...
	/**
	 * Modo de instanciaÃ§Ã£o nÃ£o permitido.
	 * 
	 * @throws IllegalStateException
	 *             Caso haja alguma tentativa de utilizaÃ§Ã£o deste construtor.
	 */
	@SuppressWarnings("unused")
	private BoletoDataBuilder(){
		Exceptions.throwIllegalStateException("InstanciaÃ§Ã£o nÃ£o permitida!");
		resourceBundle = null;
		text = null;
		image = null;
	}
	...
	/**
	 * Preenche todos os campos com os dados do boleto contido na instÃ¢ncia.
	 * 
	 * @return Esta instÃ¢ncia apÃ³s operaÃ§Ã£o
	 * 
	 * @since 0.2
	 */
	...
	private void setEndereco(Endereco endereco, String campoEndereco1, String campoEndereco2, StringBuilder sb){
		...
		if (isNotNull(endereco)) {
			...
			if (endereco.getCEP()!=null && StringUtils.isNotBlank(endereco.getCEP().getCep())) {
				sb.append(" ");
				sb.append(HIFEN_SEPERADOR);
				sb.append(" CEP: ");
	...
	private void setNossoNumero(){
		...
		StringBuilder sb = new StringBuilder(TipoDeCobranca.COM_REGISTRO==boleto.getTitulo().getContaBancaria().getCarteira().getTipoCobranca()?"14":"24");
	...
	/**
	 * AtravÃ©s da conta bancÃ¡ria serÃ¡ descoberta a imagem que representa o
	 * banco, com base no cÃ³digo do banco.
	 */
	private void setLogotipoDoBanco(){
					...
					if (isNotNull(imgLogoBanco)) {
						...
						if (log.isDebugEnabled()) {
							log.debug("Banco sem imagem da logo informada. "
									+ "Com base no cÃ³digo de compensaÃ§Ã£o do banco, uma imagem foi "
									+ "encontrada no resource e estÃ¡ sendo utilizada.");
						}
					}
		...
		if (isNotNull(imgLogoBanco)) {
			...
			log.warn("Banco sem imagem definida. O nome da instituiÃ§Ã£o serÃ¡ usado como logo.");
	...
	/**
	 * <p>
	 * Coloca a logo do passada na ficha de compensaÃ§Ã£o do boleto e no recibo do
	 * sacado.
	 * </p>
	 * 
	 * @param imgLogoBanco
	...
	/**
	 * <p>
	 * Coloca a nome do banco na ficha de compensaÃ§Ã£o do boleto e no recibo do
	 * sacado.
	 * </p>
	 * 
	 * @param nomeBanco
	...
	/**
	 * <p>
	 * Coloca as imagens dos campos no pdf de acordo com o nome dos campos do boleto atribuÃ­dos no map e templante.
	 * </p>
	 * 
	 * @since 0.2
	 */
