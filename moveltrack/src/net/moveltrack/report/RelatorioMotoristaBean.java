...
@Named
@ViewScoped
public class RelatorioMotoristaBean extends Report implements Serializable {
	...
	protected void setJRBeanCollectionDataSource() {
		...
		if(loginBean.getPessoaLogada() instanceof Cliente) {
			...
			list = reportDao.getRelatorioMotorista(cliente,grb.getInicio(),grb.getFim());
		}else
			list = reportDao.getRelatorioMotorista(null,grb.getInicio(),grb.getFim());
